...
# Generated on: Wed Dec 04 21:39:52 MST 2024 (Thu Dec 05 04:39:52 UTC 2024)
...
set logfile logs_Dec04-21:39:36/rtl2intermediate.lec.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/bridge_soc_top -revised fv_map
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  /home/u1500738/Projects/uart_can_bridge/genus/RTL/uart_can_bridge.v /home/u1500738/Projects/uart_can_bridge/genus/RTL/can_rx.v /home/u1500738/Projects/uart_can_bridge/genus/RTL/can_tx.v /home/u1500738/Projects/uart_can_bridge/genus/RTL/uart_rx.v /home/u1500738/Projects/uart_can_bridge/genus/RTL/uart_tx.v
elaborate_design -golden -root {bridge_soc_top} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/bridge_soc_top/fv_map.v.gz
...
#add_name_alias fv/bridge_soc_top/fv_map.singlebit.original_name.alias.json.gz -revised
...
add_black_box pad_in pad_out -golden
...
set_system_mode lec
write_compared_points noneq.compared_points.bridge_soc_top.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.bridge_soc_top.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.bridge_soc_top.rtl.fv_map.rpt
