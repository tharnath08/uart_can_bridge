...
# Generated on: Sun Dec 01 17:24:18 MST 2024 (Mon Dec 02 00:24:18 UTC 2024)
...
set logfile logs_Dec01-17:24:06/intermediate2final.lec.log ;# user can modify this name for succeeding runs
...
set_verification_information fv_map_uart_can_bridge_mv_db

read_implementation_information fv/uart_can_bridge -golden fv_map -revised uart_can_bridge_mv
...
read_design -verilog95   -golden -lastmod -noelab fv/uart_can_bridge/fv_map.v.gz
elaborate_design -golden -root {uart_can_bridge}

read_design -verilog95   -revised -lastmod -noelab outputs_Dec01-17:24:06/uart_can_bridge_m.v
elaborate_design -revised -root {uart_can_bridge}

#add_name_alias fv/uart_can_bridge/fv_map.singlebit.original_name.alias.json.gz -golden
...
#add_name_alias fv/uart_can_bridge/uart_can_bridge_mv.singlebit.original_name.alias.json.gz -revised
...
write_compared_points noneq.compared_points.uart_can_bridge.fv_map.uart_can_bridge_mv.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.uart_can_bridge.fv_map.uart_can_bridge_mv.rpt
}
report_test_vector -noneq > noneq.test_vector.uart_can_bridge.fv_map.uart_can_bridge_mv.rpt
