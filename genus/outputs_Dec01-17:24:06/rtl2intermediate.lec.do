...
# Generated on: Sun Dec 01 17:24:15 MST 2024 (Mon Dec 02 00:24:15 UTC 2024)
...
set logfile logs_Dec01-17:24:06/rtl2intermediate.lec.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/uart_can_bridge -revised fv_map
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  /home/u1500738/Projects/uart_can_bridge/genus/RTL/uart_can_bridge.v /home/u1500738/Projects/uart_can_bridge/genus/RTL/can_rx.v
elaborate_design -golden -root {uart_can_bridge} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/uart_can_bridge/fv_map.v.gz
...
#add_name_alias fv/uart_can_bridge/fv_map.singlebit.original_name.alias.json.gz -revised
...
add_black_box can_tx uart_rx uart_tx -golden
...
set_system_mode lec
write_compared_points noneq.compared_points.uart_can_bridge.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.uart_can_bridge.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.uart_can_bridge.rtl.fv_map.rpt
