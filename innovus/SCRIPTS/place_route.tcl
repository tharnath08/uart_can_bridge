...
proc floorplan_design {} {
   ...
   # Place instances for uart_can_bridge design

   # Assuming the following instance names based on your RTL module:
   # placeInstance soc 318 1057 R0
   # addHaloToBlock 8 8 8 8 -fromInstBox -snapToSite soc

   # Place UART-related components
   #placeInstance soc* 318 575 R0
   #addHaloToBlock 2 2 2 2 -fromInstBox -snapToSite soc*

   # placeInstance soc/uart_rx_inst 315 575 R0
   # addHaloToBlock 2 2 2 2 -fromInstBox -snapToSite soc/uart_rx_inst

   # # Place CAN-related components
   # placeInstance soc/can_tx_inst 318 805 R0
   # addHaloToBlock 2 2 2 2 -fromInstBox -snapToSite soc/can_tx_inst

   # placeInstance soc/can_rx_inst 315 805 R0
   # addHaloToBlock 2 2 2 2 -fromInstBox -snapToSite soc/can_rx_inst
